...
Для проверки делаю курл внутри кластера к фронтенд и из вне

              root@mck-t-k8s-cp1:~/test-k8s-oleg/devkub-homeworks/13-kubernetes-config/task2# curl 10.233.20.198:8000
              <!DOCTYPE html>
              <html lang="ru">
              <head>
                  <title>Список</title>
              ...
              </html>root@mck-t-k8s-cp1:~/test-k8s-oleg/devkub-homeworks/13-kubernetes-config/task2#

Из вне

              C:\Users\ORovenskij>curl 10.102.8.80:32756
              <!DOCTYPE html>
              <html lang="ru">
              <head>
                  <title>╨б╨┐╨╕╤Б╨╛╨║</title>
